    app.component('pager', {
        ...
        <div v-if="!$parent.loading" id="navi" class="ui buttons" :class="{inverted: $parent.settings.dark}" >
            ...
            <button v-if="$parent.settings.refresh >= 1" @click="$parent.loadEmails(false)" class="ui button navi" :class="{inverted: $parent.settings.dark}">
            ...
            <button v-else @click="$parent.loadEmails(false)" class="ui button navi" :class="{inverted: $parent.settings.dark}">
